...
const UserProfileSidebar:React.FC<UserSidebarProps> = ({userData,setEdit,isEdit}) => {
    ...
    const handleSubmit = async()=>{
        try {
            ...
            const response = await editProfile({id,firstName,lastName,phone,gender,age})
    ...
    <div className='user-sidebar' >
        <div className='profile-image'>
            ...
            {isEdit ? 
                <div className='edit-btn'>
                    ...
                    <input type="file" id="fileInput" name="image" style={{ display: 'none' }}  onChange={(e) => handleImgChange(e.target.files ? e.target.files[0] : null)} />
                    <label htmlFor="fileInput" className='btn'>Edit Image</label>
                </div> :
        ...
        {isEdit ? 
            <div className='edit-details' >
                ...
                <input type="text" value={`${age ? age : ''}`} onChange={(e)=>setAge(Number(e.target.value))} placeholder='Age'/>
