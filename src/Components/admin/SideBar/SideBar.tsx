      ...
      >
        ...
        <div className={`sidebar-list ${isOpen ? "show" : ""}`}>
          <ul>
            ...
            <Link to="/admin/pricing-management" className="sidebar-link">
              <li className={isActive("/admin/pricing-management")}>
                <span className="sidebar-icons">
                  <IoMdPricetags />
                </span>
                {isOpen && "Pricing"}
            ...
            <Link to="/admin/event-management" className="sidebar-link">
              <li className={isActive("/admin/event-management")}>
                <span className="sidebar-icons">
                  <IoMdList />
                </span>
                {isOpen && "Events"}
            ...
            <Link to="/admin/ticket-management" className="sidebar-link">
              <li className={isActive("/admin/ticket-management")}>
                <span className="sidebar-icons">
                  <IoTicketSharp />
                </span>
                {isOpen && "Entry Pass"}
